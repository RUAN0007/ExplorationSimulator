...
public class ExplorationComputer {
	...
	private boolean hasRobotTouchedOnEdge = false;
	...
	private boolean robotInExploreState = true;
	...
	private Orientation getArenaNearestEdgeToRobot(Robot robot) {
...
//	}
	...
	private Direction moveTowardsOrientation(Robot robot, Orientation targetOrientaiton){
